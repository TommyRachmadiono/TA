...
-- Table `ta`.`jenjang`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ta`.`jenjang` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `nama_jenjang` VARCHAR(10) NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ta`.`matpel` (
  ...
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_matpel_jenjang1_idx` (`jenjang_id` ASC)  COMMENT '',
  CONSTRAINT `fk_matpel_jenjang1`
    FOREIGN KEY (`jenjang_id`)
    REFERENCES `ta`.`jenjang` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ta`.`noitf_socmed`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ta`.`noitf_socmed` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
