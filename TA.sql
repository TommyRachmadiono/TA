...
CREATE TABLE IF NOT EXISTS `ta`.`matpel_has_week` (
  ...
  `tugas_id` INT NULL COMMENT '',
  `materi_id` INT NULL COMMENT '',
  INDEX `fk_matpel_has_week_week1_idx` (`week_id` ASC)  COMMENT '',
  INDEX `fk_matpel_has_week_matpel1_idx` (`matpel_id` ASC)  COMMENT '',
  INDEX `fk_matpel_has_week_tugas1_idx` (`tugas_id` ASC)  COMMENT '',
  INDEX `fk_matpel_has_week_materi1_idx` (`materi_id` ASC)  COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  ...
  CONSTRAINT `fk_matpel_has_week_week1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_matpel_has_week_tugas1`
    FOREIGN KEY (`tugas_id`)
    REFERENCES `ta`.`tugas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_matpel_has_week_materi1`
    FOREIGN KEY (`materi_id`)
    REFERENCES `ta`.`materi` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
