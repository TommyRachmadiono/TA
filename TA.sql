...
CREATE TABLE IF NOT EXISTS `ta`.`kelas` (
  ...
  UNIQUE INDEX `nama_kelas_UNIQUE` (`nama_kelas` ASC)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ta`.`matpel` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `nama_pelajaran` VARCHAR(45) NOT NULL COMMENT '',
  `jenjang_id` ENUM('1', '2', '3') NOT NULL COMMENT '',
  `jurusan` ENUM('IPA', 'IPS') NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ta`.`anggota` (
  ...
  PRIMARY KEY (`user_id`, `grup_id`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `ta`.`postingan` (
  ...
  `file` VARCHAR(255) NULL COMMENT '',
  PRIMARY KEY (`idpostingan`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `ta`.`komentar` (
  ...
  `file` VARCHAR(255) NULL COMMENT '',
  PRIMARY KEY (`idkomentar`)  COMMENT '',
...
-- -----------------------------------------------------
-- Table `ta`.`notif_socmed`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ta`.`notif_socmed` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `nama_notif` VARCHAR(255) NOT NULL COMMENT '',
  `idpostingan` INT NOT NULL COMMENT '',
  `id_penerima` INT NOT NULL COMMENT '',
  `time` DATETIME NULL COMMENT '',
  `seen` TINYINT(1) NULL COMMENT '',
  `idkomentar` INT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_noitf_socmed_postingan1_idx` (`idpostingan` ASC)  COMMENT '',
  INDEX `fk_noitf_socmed_user1_idx` (`id_penerima` ASC)  COMMENT '',
  INDEX `fk_notif_socmed_komentar1_idx` (`idkomentar` ASC)  COMMENT '',
  CONSTRAINT `fk_noitf_socmed_postingan1`
    FOREIGN KEY (`idpostingan`)
    REFERENCES `ta`.`postingan` (`idpostingan`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_noitf_socmed_user1`
    FOREIGN KEY (`id_penerima`)
    REFERENCES `ta`.`user` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_notif_socmed_komentar1`
    FOREIGN KEY (`idkomentar`)
    REFERENCES `ta`.`komentar` (`idkomentar`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
